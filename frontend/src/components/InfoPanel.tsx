...
export default function InfoPanel({ feature, onClose }: InfoPanelProps) {
  ...
  return (
    <div className="bg-white/95 backdrop-blur-sm border border-stone-200 rounded-2xl sm:rounded-xl shadow-lg w-full sm:w-72 max-w-md overflow-hidden max-h-[50vh] sm:max-h-none">
      {/* Header */}
      <div className="flex items-start justify-between p-4 pb-3 border-b border-stone-100">
        ...
        <button
          onClick={onClose}
          className="text-stone-400 hover:text-stone-700 transition-colors flex-shrink-0 -mt-0.5 -mr-0.5 min-h-[44px] min-w-[44px] inline-flex items-center justify-center"
          aria-label="Close"
        >
