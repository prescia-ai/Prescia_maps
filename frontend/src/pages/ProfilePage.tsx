        ...
        {(!isPrivate || isOwnProfile) && (
          <div className="space-y-0">
            ...
            <div className="flex border-b border-slate-800">
              {(['activity', 'hunts', 'friends'] as ActiveTab[]).map((tab) => (
                <button
                  key={tab}
            ...
            {/* Tab content */}
            <div className="bg-slate-900/50 border border-t-0 border-slate-800 rounded-b-3xl p-8 flex flex-col items-center justify-center gap-3 min-h-[160px] text-center">
              {activeTab === 'activity' && (
                <>
